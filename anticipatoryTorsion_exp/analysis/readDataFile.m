...
if data.startFrames(1)>800 % should be around 600 for the first fixation trial...
    % "null" the first trial; shift the trials to their supposed position
    data.startFrames(2:200) = data.startFrames(1:199);
    data.endFrames(2:200) = data.endFrames(1:199);
    data.startFrames(1) = 1;
    data.endFrames(1) = 599;
end
