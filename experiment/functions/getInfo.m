...
n = 1;
q{n} = 'subID'; defaults{n} = 'PH3'; n = n+1;
...
q{n} = 'Experiment type(-1=base, 0=baseTorsion, 1=exp, 1.5=control)'; defaults{n} = num2str(expTyp); n = n+1;
...
% info.headTilt = str2num(answer{n}); n = n+1;
