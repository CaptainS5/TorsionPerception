...
% experimentFolder = ['C:\Users\CaptainS5\Documents\PhD@UBC\Lab\1st year\Torsion&perception\data\IC\chronos'];%[folder{:} '\' subject '\chronos']; % for debug
...
%% change here
data.totalFrames = triggeredFrames + nonTriggeredFrames-13550;
...
for i = 1:recordedBlocks-1
    ...
    %% change here
    data.startFrames(i) = frame{1}-13550;
    data.endFrames(i) = frame{2}-13550;
end
