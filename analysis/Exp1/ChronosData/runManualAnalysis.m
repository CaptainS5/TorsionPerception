...
buttons.totalError = uicontrol(fig,'string','Loss of signal (3) >>','Position',[0,220,100,30],...
...
buttons.pursuitError = uicontrol(fig,'string','Blink/Fixation error (1) >>','Position',[0,150,100,30],...
