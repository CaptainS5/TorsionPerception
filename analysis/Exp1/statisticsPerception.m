...
disp(['baseline valid trial number: ', num2str(mean(1-validBase/trialBaseAll)), ' +- ', num2str(std(1-validBase/trialBaseAll))])
disp(['exp valid trial number: ', num2str(mean(1-validExp/trialExpAll)), ' +- ', num2str(std(1-validExp/trialExpAll))])
