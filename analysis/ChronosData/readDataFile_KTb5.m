...
% experimentFolder = ['C:\Users\CaptainS5\Documents\PhD@UBC\Lab\1st year\Torsion&perception\data\KT\chronos'];%[folder{:} '\' subject '\chronos']; % for debug
...
%% change here
data.totalFrames = triggeredFrames + nonTriggeredFrames-10583;
...
for i = 1:recordedBlocks-1
    ...
    %% change here
    data.startFrames(i) = frame{1}-10583;
    data.endFrames(i) = frame{2}-10583;
end
